...
```
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-sunset-8f36
```

A live public deployment of this template is available at [https://sweet-sunset-8f36.templates.workers.dev](https://sweet-sunset-8f36.templates.workers.dev)
